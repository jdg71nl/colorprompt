...
#
# --[CWD=$HOME/opensyssetup(git:main)]--[1705867071 20:57:51 Sun 21-Jan-2024 CET]--[jdg@MB18-jdg71nl]--[os:MacOS--13.6.3,isa:x86_64]------
...
# "I solved this problem by adding an alias for htop in $HOME/.bashrc: alias htop='TERM=xterm-color htop' "
...
if [ -r $HOME/opensyssetup/bin/oss-check-repo.sh ]; then
  $HOME/opensyssetup/bin/oss-check-repo.sh
fi

if [ -r $HOME/opensyssetup/bin/write_distro_file.sh ]; then
  $HOME/opensyssetup/bin/write_distro_file.sh silent
fi
...
DISTROFILE="$HOME/opensyssetup/distro.info"
...
# "To silence this warning, you can add this command to $HOME/.bash_profile or $HOME/.profile: "
export BASH_SILENCE_DEPRECATION_WARNING=1

#===============================================================
# make sure we leave as a good neighbour:
test 1 -eq 1
#===============================================================
#===============================================================
#-eof
